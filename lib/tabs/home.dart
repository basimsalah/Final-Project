import 'package:finalproject/model/product.dart';
import 'package:finalproject/model/productResponse.dart';
import 'package:finalproject/network/ServiceApi.dart';
      ...
      appBar: AppBar(
        actions: [
          Padding(
            ...
            child: Icon(
              Icons.filter_alt_outlined, color: Colors.deepOrange, size: 30,),
          )
        ],
